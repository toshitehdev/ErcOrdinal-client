...
function Bounty() {
  return (
    <div className="min-h-screen text-white w-full py-5">
      <div className="mt-5 w-10/12 max-w-[1300px] mx-auto h-full my-0">
        <div className="mb-5">
          <NavLink
            ...
            className={({ isActive }) => {
              ...
              return (
                cn +
                ` block mb-3 lg:inline text-xs border border-indigo-500 px-5 py-2 rounded-full mr-4 font-semibold`
              );
            }}
          >
            Free Mint Bounties
